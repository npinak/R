...
#1) False
#2) True - Every year there are more boys born than girls.
#3) False
```
...
# 1)False
# 2)False
# 3)True - There is initially a decrease in the boy-to-girl ratio, and then an increase between 1960 and 1970, followed by a decrease.
# 4) False
# 5) False
```
...
# 2007 is the year with the highest number of births
```
